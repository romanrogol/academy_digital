...
export const Pagination: React.FC<PaginationProps> = ({ totalPages }) => {
    ...
    return (
        <div className="pagination">
            <div 
                className={` ${currentPage === 1 ? 'page-left-disabled' : 'page-left-active'}`} 
            ...
            <div 
                className={` ${currentPage === totalPages ? 'page-right-disabled' : 'page-right-active'}`} 
                onClick={handleNext}
            >
                <div className="img-wrap">
                    <img 
                        src={currentPage === totalPages ? rightDisabledIcon : rightActiveIcon} 
                        alt='Next' 
                    />
                </div>
            </div>
